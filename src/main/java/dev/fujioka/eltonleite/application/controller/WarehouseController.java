...
public class WarehouseController {
    ...
    private final BaseService<Warehouse> service;

    private final ResponseService responseService;

    public WarehouseController(final BaseService<Warehouse> service, final ResponseService responseService) {
        super();
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ResponseTO<WarehouseResponseTO>> update(@PathVariable Long id,
            @RequestBody WarehouseRequestTO requestTO) {
        Warehouse warehouse = WarehouseAssembler.from(requestTO);
